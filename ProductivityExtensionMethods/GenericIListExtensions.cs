...
namespace System.Data
{
    ...
    public static partial class GenericIListExtensions
    {
        ...
        {
            return AddRangeUnique(list, objs, new ProductivityExtensionMethods.Common.EqualityComparer<T>(comparer));
        }
        ...
        {
            return AddUnique(list, obj, new ProductivityExtensionMethods.Common.EqualityComparer<T>(comparer));
        }

        public static bool AddUnique<T>(this IList<T> list, T obj, Func<T, T, bool> comparer, Func<T, int> hash)
        {
            return AddUnique(list, obj, new ProductivityExtensionMethods.Common.EqualityComparer<T>(comparer, hash));
        }
